...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PRIMEACE | Software Agency & AI Automation" },
      { property: "og:description", content: "Premium software agency building custom software, AI automation and scalable digital products." },
